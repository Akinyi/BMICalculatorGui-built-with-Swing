...
public class TDDmedKalkylator extends JFrame implements ActionListener {
 JLabel nameLabel = new JLabel("Namn:");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == name || ae.getSource() == weight 
            ...
            if (scLength.hasNextDouble() && scWeight.hasNextDouble()){
              ...
              // finalVerdict.setText(String.format("Addition %.2f.", addition(enteredLength, enteredWeight)));
            }
        }
    }
    ...
    public boolean openEdit(String password){
    ...
    public static int saveEdit(){
        String savedtext = "originaltext";
        return 0;
    }
